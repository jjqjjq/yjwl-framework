...
namespace ET
{
    public static class MongoHelper
    {
        ...
        [StaticField] private static List<string> _typeRegisterList;
        [StaticField] private static ObjectSerializer _objectSerializer;

        public static void Init()
        {
            // 注册bson序列化器
            _typeRegisterList = new List<string>();
            _objectSerializer = new ObjectSerializer(AllowedTypes);
            BsonSerializer.RegisterSerializer(_objectSerializer);
        }
        
        public static void CheckTypeRegister(object obj)
        {
            Type type = obj.GetType();
            if (_typeRegisterList.Contains(type.FullName))
            {
                return;
            }
            _typeRegisterList.Add(type.FullName);
        }

        private static bool AllowedTypes(Type type)
        {
            return _typeRegisterList.Contains(type.FullName);
        }

        public static string ToJson(object obj)
        {
            CheckTypeRegister(obj);
