...
namespace ET
{
    public class UnityWebChannel: AChannel
    {
        private readonly UnityWebService Service;
        ...
        public UnityWebChannel(long id, UnityWebService service, IPEndPoint ipEndPoint)
        {
            ...
            // #if UNITY_EDITOR
            // this.RemoteAddress = new IPEndPoint(ipEndPoint.Address, ipEndPoint.Port);
            // this.connectUrl = $"ws://{this.RemoteAddress}/WebRouterBehavior";
            // #else
            // this.RemoteAddress = new IPEndPoint(ipEndPoint.Address, ipEndPoint.Port+1);
            // // this.connectUrl = $"wss://{this.RemoteAddress}/WebRouterBehavior";
            // this.connectUrl = $"wss://server.release.jijianquan.cn:{this.RemoteAddress.Port}/WebRouterBehavior";
            // #endif
            
            
            this.RemoteAddress = new IPEndPoint(ipEndPoint.Address, ipEndPoint.Port);
            this.connectUrl = $"ws://{this.RemoteAddress}/WebRouterBehavior";
            Log.Info($"[WebChannel] Connect: {id} {connectUrl}");

#if WebLog
            Log.Console($"[WebChannel] Connect: {id} {connectUrl}");
#endif
