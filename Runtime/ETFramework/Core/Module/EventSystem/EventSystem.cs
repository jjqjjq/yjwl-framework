...
namespace ET
{
    public class EventSystem : Singleton<EventSystem>, ISingletonUpdate, ISingletonLateUpdate
    {
        ...
        public void Publish(Scene scene, string eventType, object o1 = null, object o2 = null, object o3 = null, object o4 = null)
        {
            Publish(scene, new ProtocolEvent() { eventType = eventType, message1 = o1, message2 = o2, message3 = o3, message4 = o4 });
        }
