...
namespace ET
{
    ...
    public class ConfigComponent: Singleton<ConfigComponent>
    {
		...
		public object LoadOneConfig(Type configType)
		{
			...
			byte[] oneConfigBytes = EventSystem.Instance.Invoke<GetOneConfigBytes, byte[]>(new GetOneConfigBytes() {ConfigName = configType.Name});
		...
		public void Load()
		{
			foreach (KeyValuePair<Type,ISingleton> keyValuePair in this.allConfig)
			{
