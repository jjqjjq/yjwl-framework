...
namespace JQFramework.tUGUI
{
    ...
    public class Gradient : BaseMeshEffect
    {
        ...
        public void setEffectGradient(Color colorA,Color colorB)
        {
            EffectGradient.colorKeys = new GradientColorKey[] { new GradientColorKey(colorA,0), new GradientColorKey(colorB,1) };
        }
