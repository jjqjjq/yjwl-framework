...
{
    [MenuItem("S3-Tools/Search For Components")]
    ...
    private string[] modes = new string[] {"Search for component usage", "Search for missing components"};
    private string[] checkType = new string[] {"Check single component", "Check all components"};
    ...
    public static string[] GetAllPrefabs()
    {
        ...
        {
            if (s.Contains("unused")) continue;
            if (s.EndsWith(".prefab")) result.Add(s);
        }
