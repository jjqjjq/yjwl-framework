            ...
            if (touched.Add(obj))
            {
                ...
                foreach (FieldInfo fi in fieldinfo)
                {
                    ...
                    if (val)
                    {
                        ...
                        else Debug.LogWarning("Null for this non-null object, property " + fi.Name + " of class " + obj.GetType().Name + ". Object _type is " + fi.FieldType.Name);
                    }
                }
                ...
                foreach (PropertyInfo pi in propertyInfo)
                {
                    ...
                    if (val)
                    {
                        ...
                        else Debug.LogWarning("Null for this non-null object, property " + pi.Name + " of class " + obj.GetType().Name + ". Object _type is " + pi.PropertyType.Name);
                    }
                }
